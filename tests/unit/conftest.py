...
@pytest.fixture
def config():
    """Fixture providing mocked configuration information."""
    defaults = {
        "mode": "http",
        "urlbase": "/test",
        "rewrite-path": None,
...
def cert(monkeypatch):
    """Mock the certificate used for HTTPS."""
    normal_open = open
...
def mock_service_reload(monkeypatch):
    """Mock service reload operations."""
...
def ph(
    ...
    """Mock the ProxyHelper instance used by the charm."""
